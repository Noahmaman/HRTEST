              ...
              {features.map((feature, index) => (
                <Link href={feature.href} key={feature.title}>
                  <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="bg-purple-900/20 backdrop-blur-lg rounded-2xl p-8 border border-purple-800/50 hover:border-purple-600/50 transition-all duration-300 cursor-pointer"
                  >
